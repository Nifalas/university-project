        ...
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-md-10 col-lg-8 col-xl-7">
                ...
                <?php if (isset($_SESSION['user_id']) and $_SESSION['user_id'] == $post->user_id) :  ?>
                    <a href="delete.php?del_id=<?php echo $post->id ?>" class="btn btn-danger text-ceter float-end">Delete</a>
                    <a href="update.php?upd_id=<?php echo $post->id ?>" class="btn btn-warning text-ceter">Update</a>
                <?php endif ?>
            </div>
        </div>
    </div>
